...
const CreateTaskModal = ({ columnTitle, initialData, onClose, onSave, boards = [], isGlobal = false, targetColumn }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (isGlobal && (!selectedBoardId || !selectedColumnId)) {
            toast.error('Por favor selecciona un tablero y una columna');
            return;
        }
                    ...
                    <form onSubmit={handleSubmit}>
                                ...
                                <div>
                                    ...
                                    <div className="relative inline-block w-full">
                                        <select
                                            ...
                                            className="w-full bg-[var(--bg-elevated)] dark:bg-[#1e293b] hover:bg-stone-50 dark:hover:bg-[#253045] border border-[var(--border-default)] dark:border-slate-700 rounded-lg pl-3 pr-10 py-2.5 text-[var(--text-primary)] dark:text-slate-200 text-sm focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 outline-none appearance-none transition-all cursor-pointer disabled:opacity-50"
                        ...
                        <div className="mb-5">
                            ...
                            <input
                                ...
                                className="w-full bg-[var(--bg-elevated)] dark:bg-[#1e293b] border border-[var(--border-default)] dark:border-slate-700 rounded-lg px-4 py-3 text-[var(--text-primary)] placeholder-[var(--text-muted)] focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 outline-none transition-all font-medium"
                            />
                        </div>
                        ...
                        <div className="mb-5">
                            ...
                            <textarea
                                ...
                                className="w-full bg-[var(--bg-elevated)] dark:bg-[#1e293b] border border-[var(--border-default)] dark:border-slate-700 rounded-lg px-4 py-3 text-[var(--text-secondary)] dark:text-slate-300 placeholder-[var(--text-muted)] focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 outline-none transition-all h-24 resize-none custom-scrollbar"
                            />
                        </div>
                            ...
                            <>
                                <div className="mb-5">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-[var(--bg-elevated)] dark:bg-[#1e293b] border border-[var(--border-default)] dark:border-slate-700 rounded-lg px-4 py-2.5 text-[var(--text-secondary)] dark:text-slate-300 placeholder-[var(--text-muted)] focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 outline-none transition-all"
                                    />
                                </div>
                                ...
                                <div className="mb-6">
                                    {!showChecklist && checklistItems.length === 0 ? (
                                        ...
                                        <div className="bg-stone-100 dark:bg-[#1e293b]/50 p-4 rounded-xl border border-dashed border-[var(--border-default)] dark:border-slate-700/50">
                                            ...
                                            <div className="space-y-2 mb-3">
                                                {checklistItems.map(item => (
                                                    <div key={item.id} className="flex items-center gap-3 text-sm text-[var(--text-secondary)] bg-[var(--bg-primary)] p-2 rounded-lg border border-[var(--border-subtle)] dark:border-slate-800 group">
                                            ...
                                            <div className="flex gap-2">
                                                <input
                                                    ...
                                                    className="flex-1 bg-[var(--bg-primary)] border border-[var(--border-default)] dark:border-slate-700 rounded-lg px-3 py-2 text-sm text-[var(--text-primary)] focus:border-indigo-500 outline-none placeholder-[var(--text-muted)] transition-colors"
                                                />
                                                <button
                                                    type="button"
